...
<center>
        ...
        <div class="wrap-login100" style="width: 100%">
            ...
            <form action="admin_view_inventory_backend.php" method="GET">
                ...
                <div class="wrap-input100 rs1-wrap-input100 validate-input"
                     data-validate="Inventory Id is required">
                    <!-- <span class="label-input100">Medicine Quantity</span> -->
                    <input class="input100" type="text" name="inventory_id" placeholder="Enter Inventory Id quantity" required="
	true">
                ...
                <div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="Medicine Id is required">
                    ...
                    <input class="input100" type="text" name="medicine_id" placeholder="Enter Medicine id"
                           required="true">
                    <span class="focus-input100"></span>
                </div>
                ...
                <div class="wrap-input100 rs1-wrap-input100 validate-input"
                     data-validate="Medicine quantity is required">
                    <!-- <span class="label-input100">Medicine Quantity</span> -->
	...
	true">
                ...
                <div class="wrap-input100 rs1-wrap-input100 validate-input"
                     data-validate="Medicine Manufacture Date is required">
                    <!-- <span class="label-input100">Medicine Manufacture Date</span> -->
                    <input class="input100" type="text" name="manufacture_date"
                           placeholder="Enter Medicine Manufacture Date" required="
	true">
                    <span class="focus-input100"></span>
                </div>
                <!-- echo 'Expiry Date: <input type="text" name="expiry_date"><br>'; -->
                <div class="wrap-input100 rs1-wrap-input100 validate-input"
                     data-validate="Medicine Expiry Date is required">
                    <!-- <span class="label-input100">Medicine Expiry Date</span> -->
                    <input class="input100" type="text" name="expiry_date" placeholder="Enter Medicine Expiry Date"
                           required="
	true">
                    <span class="focus-input100"></span>
                </div>
